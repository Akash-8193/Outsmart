      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
        ...
        <div className="w-full lg:w-1/2">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="relative w-full aspect-[4/5] md:aspect-square lg:aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl"
          >
            <div 
            ...
            {/* Bottom Dark Bar */}
            <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6 bg-gray-900/95 backdrop-blur-md p-5 md:p-6 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start">
          ...
          <motion.h2 
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight"
          >
          ...
          >
            <Link 
              href="/contact"
              className="inline-flex items-center gap-4 px-8 py-4 rounded-full text-white font-bold text-lg transition-transform hover:-translate-y-1 shadow-xl hover:shadow-[--primary]/50"
