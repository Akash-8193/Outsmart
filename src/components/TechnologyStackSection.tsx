        ...
        <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-6">
          {stack.map((item, idx) => (
            <motion.div
              ...
              className={`bg-white rounded-[2.5rem] p-8 lg:p-10 relative overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-gray-100 group flex flex-col h-full hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] transition-all duration-500 md:col-span-6 ${item.colSpan}`}
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex items-start justify-between mb-8">
                  ...
                  <div 
                    className="font-black text-6xl leading-none italic transition-colors duration-500 select-none text-transparent bg-clip-text"
                    style={{ 
