      ...
      <div className="pt-32 pb-20 px-6 min-h-screen relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row gap-16">
          <div className="w-full md:w-5/12">
            ...
            >
              Whether you need a custom enterprise platform or an autonomous AI agent, we're ready to build the future with you.
            </motion.p>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">hello@outsmart.tech</p>
                </div>
              </div>
